...
import br.inatel.labs.labjpa.service.ForcedorService;
...
class DataLoader {
	...
	@Autowired
	private ForcedorService fornecedorService;
	@Autowired
	...
	void load() {
		...
		NotaCompraItem i2_1 = new NotaCompraItem(nc2, p3, new BigDecimal("400.00"), 7);
		NotaCompraItem i2_2 = new NotaCompraItem(nc2, p4, new BigDecimal("1000.00"), 2);
